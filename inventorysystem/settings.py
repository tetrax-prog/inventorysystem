...
SECRET_KEY = 'django-insecure-lml!+ztf_5_$0uby#v=dkr1fns$6_0to*c-)^4m*1!28-vcqqu'
...
LOGIN_REDIRECT_URL = 'dashboard-index' #redirect url for redirecting to a page upon login
